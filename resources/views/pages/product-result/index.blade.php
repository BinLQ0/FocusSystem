...
<div class="row d-flex justify-content-center">
    ...
    <div class="col-9">
        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-4">
                <x-button id='btn_create' :url='route("product-result.create")' class='bg-success btn-sm' icon='far fa-plus-square' label='Create' />
            </div>
        ...
        <x-card theme-mode='outline' theme='primary' component='tables.product-result-table' body-class='p-0' />
    </div>
</div>
